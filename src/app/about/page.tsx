...
import { FounderProfile, FounderBioFull } from "@/components/FounderProfile";
import { company, financialMission, founder } from "@/lib/content";

export const metadata: Metadata = {
  title: "About Us",
  description:
    "Learn about Royal Wealth Heritage LLC and founder Helena C. Puati — CEO, Educational Director, and certified Special Education teacher.",
};
      ...
      <section className="bg-white/60 px-4 py-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl">
          <SectionHeading
            ...
            description={founder.missionStatement}
            align="left"
          />
          <div className="mt-10">
            <FounderBioFull />
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-12 grid gap-8 lg:grid-cols-2">
            ...
            <article className="rounded-3xl border border-border bg-white p-8">
              ...
              <p className="mt-3 text-sm leading-relaxed text-muted">
                Structured educational support for students with autism, dyslexia, communication
                challenges, and diverse learning needs — led by {founder.name}.
              </p>
              <Link
                href="/academy"
